...
excerpt: "Exposing an internal API to an agent is a five-line decorator. Doing it without handing every developer's agent a confused deputy into your production estate is the actual engineering. Here is the part that isn't in the quickstart."
---
